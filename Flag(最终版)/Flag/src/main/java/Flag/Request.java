...
public class Request {
    ...
    @GetMapping("/login")
    public String login() {
        return "redirect:https://openapi.yiban.cn/oauth/authorize?client_id=" + id + "&redirect_uri=http://yiban.arukione.cn/OAuth";
    }
    ...
    public String getAccess(String code) {
        ...
        multiValueMap.add("redirect_uri", "http://yiban.arukione.cn/OAuth");
