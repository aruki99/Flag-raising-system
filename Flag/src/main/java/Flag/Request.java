...
//                 ) throws  IOException {
//
////      System.out.println(getName(getAccess(code)));
//                                                        //参数是易班标准40位的code才放行（简单设防）
//
//      if (code.length() == 40) {
//          this.userName=getInfs(getAccess(code),"yb_realname");
...
//  }
 ...
 long a =System.currentTimeMillis();
        ...
        if (access_token != null) {
            ...
            session.setAttribute("userName",getInfs(getAccess(code),"yb_realname"));

            session.setAttribute("id",getInfs(getAccess(code),"yb_id"));
 ...
 long b =System.currentTimeMillis();
    ...
    //获取个人信息，取姓名，id
    public HashMap<String, String> getInfs(String access_token, String need){
